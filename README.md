...
[![Documentation Status](https://readthedocs.org/projects/poktbot/badge/?version=v0.1.1)](https://poktbot.readthedocs.io/en/v0.1.1/?badge=v0.1.1)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://raw.githubusercontent.com/cryptonglab/poktbot/v0.1.1/LICENSE)
...
![graph](https://raw.githubusercontent.com/cryptonglab/poktbot/v0.1.1/docs/images/poktbot.gif "Graph")

## Docs
* [Getting started](https://poktbot.readthedocs.io/en/v0.1.1/).
* [Installation guide](https://poktbot.readthedocs.io/en/v0.1.1/installation/).
* [Configuration guide](https://poktbot.readthedocs.io/en/v0.1.1/configuration/).


## Features
* Provides an easy way to monitoring Pocket Network validator nodes status.
    * Errors monitoring and notification.  
    ![Cert-expiration](https://raw.githubusercontent.com/cryptonglab/poktbot/v0.1.1/docs/images/certificate_expiration_min.png "Certification expired")
    * Staking monitoring and notification.  
    ![Begin-unstake](https://raw.githubusercontent.com/cryptonglab/poktbot/v0.1.1/docs/images/begin_unstake_min.png "Begin unstake")
...
* Provides useful stats about node rewards and performance.  
    ...
    * Graph of rewards evolution.  
    ![Stats-result](https://raw.githubusercontent.com/cryptonglab/poktbot/v0.1.1/docs/images/stats.png "Stats result")
...
![Balances](https://raw.githubusercontent.com/cryptonglab/poktbot/v0.1.1/docs/images/balances.png "Balances")
